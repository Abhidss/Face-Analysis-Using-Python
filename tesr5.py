...
def calculate_face_shape(landmarks):
    ...
    # Added more refined shape classification including oblong
    if 0.75 < width_height_ratio < 0.85 and jaw_to_cheekbone_ratio < 0.9:
        ...
        return "Square"
    elif 0.65 < width_height_ratio <= 0.75 and jaw_to_cheekbone_ratio > 0.85:
        return "Rectangle"
    elif width_height_ratio <= 0.65 and jaw_to_cheekbone_ratio > 0.85:
        return "Oblong"
...
def main():
    ...
    age_labels = ['(0-5)', '(6-10)', '(11-15)', '(16-20)', '(21-25)', '(26-30)', '(31-35)',
                  '(36-40)', '(41-100)']
    ...
    while True:
        ...
        # Detect face shape and annotate
